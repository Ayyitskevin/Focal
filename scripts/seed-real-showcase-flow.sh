...
echo "==> anonymize gallery $GALLERY_ID case study"
...
ANON_COUNT="$(curl -sS 'https://kleephotography.com/' | grep -c 'Independent Restaurant' || true)"
echo "  kleephotography.com: Mise Demo=$DEMO_COUNT Independent Restaurant=$ANON_COUNT"
