...
| [0066](0066-native-api-opaque-session-boundary.md) | Native API auth boundary: host-first tenant resolution, bearer-only opaque rotating sessions, exact resource guest scopes, origin-scoped Keychain storage, and a scoped `/api/v1` OpenAPI contract | Proposed |
