...
def test_platekit_slug_falls_back_to_company_or_name():
    assert platekit.slug_for_client({"name": "Avery", "company": "Blue Plate", "platekit_slug": ""}) == "blue-plate"
    assert platekit.slug_for_client({"name": "Avery Studio", "company": "", "platekit_slug": ""}) == "avery-studio"
