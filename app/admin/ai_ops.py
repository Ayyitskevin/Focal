...
The consolidation shipped several surfaces (the ai_runs ledger, the validation gate). This
page is the morning glance that ties them together: what needs my attention across all of
them, and how is the AI spend/activity trending. It is the "one pane of glass" the Solo
Studio OS arc was building toward.

Pure aggregation — it reads the ai_runs ledger and the validation gate, and writes nothing.
Every actionable item links to the queue that owns the action; nothing is decided or
promoted here.
"""
